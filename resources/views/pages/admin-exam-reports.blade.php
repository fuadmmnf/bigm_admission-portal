        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <section class="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
                ...
                <div class="mt-3 rounded-lg border border-gray-200 p-4 flex flex-wrap items-center justify-between gap-3">
                    ...
                    @if (auth()->user()?->hasRole('admin'))
                        <a href="{{ route('admin.exams.reports.gender-wise-applicants', $exam) }}" target="_blank" rel="noopener" class="inline-flex items-center px-3 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700">
                ...
                <div class="mt-3 rounded-lg border border-gray-200 p-4 flex flex-wrap items-center justify-between gap-3">
                    ...
                    @if (auth()->user()?->hasRole('admin'))
                        <a href="{{ route('admin.exams.reports.employer-wise', $exam) }}" target="_blank" rel="noopener" class="inline-flex items-center px-3 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700">
                ...
                <div class="mt-3 rounded-lg border border-gray-200 p-4 flex flex-wrap items-center justify-between gap-3">
                    <div>
                        <p class="text-sm font-semibold text-gray-900">Choice List Wise Report</p>
                        <p class="text-xs text-gray-500">Placeholder format; content structure will be updated later.</p>
                    </div>
