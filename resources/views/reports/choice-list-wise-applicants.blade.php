...
<head>
    <meta charset="UTF-8">
    <title>Choice List Wise Applicants - {{ $exam->name }}</title>
    <style>
...
<body>
    <h2>Choice List Wise Report (Placeholder)</h2>
        ...
        <tbody>
            @forelse ($applications as $index => $application)
                <tr>
                    ...
                    <td>{{ data_get($application->additional_info, 'course_preferences.first_choice', 'N/A') }}</td>
                </tr>
            @empty
